  ...
  <fieldset class="mb-4">
    ...
    <div class="mt-3">
      <div v-if="question.type === 'select'">
        ...
        @change="emits('update:modelValue',$event.target.value)" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md 
      ...
      <div v-else-if="question.type === 'checkbox'">
        <div v-for="(option, ind) of question.data.options" :key="option.uuid" class="flex items-center">
          <input type="checkbox" :id="option.uuid" 
...
<script setup>
import { ref } from "vue";
 const{ question, index, modelVal } = defineProps({
  question: Object,
  index: Number,
