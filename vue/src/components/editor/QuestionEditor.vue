<template>
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-9">
            <label for="'question_text_' + model.data" class="block text-sm font-medim text-gray-700">
                Question Text</label>
        ...
        <div class="mt-3 col-span-3">
            ...
            <select id="question_type" name="question_type" v-model="model.type" @change="dataChange" class="
              mt-1
              block
              w-full
              py-2
...
//re-create the whole question data to avoid uninternation refreence change
