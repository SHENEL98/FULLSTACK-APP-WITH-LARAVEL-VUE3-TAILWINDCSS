<template>
    <div class="py-5 px-8">
        ...
        <form v-else @submit.prevent="submitSurvey" class="container mx-auto">
            ...
            <div v-else>
                <hr class="my-3">
                <div v-for="(question, indec) of survey.questions" :key="question.id">
                    <QuestionViewer v-model="answers[question.ud]" 
                        :question="question" :index="indec"/>
                </div>
                <button
                    type="submit"
